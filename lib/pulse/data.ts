...
export async function getPulseMetrics():Promise<PulseMetrics>{
 ...
 let settings=fallback; let income:{entry_date:string;amount:number;amount_actual?:number|null}[]=[{entry_date:"2026-06-14",amount:2200},{entry_date:"2026-06-14",amount:2300}]; let appointmentCount=1;
