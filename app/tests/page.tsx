...
export default function TestsPage() { return <main className="tests-page"><div className="tests-shell">
  ...
  <section className="tests-section"><div className="tests-heading"><div><p className="portal-kicker">Pick a small experiment</p><h2>從現在最有感覺的地方開始。</h2></div><p>每一個工具都只是整理線索，不替你診斷，也不急著替你下結論。</p></div>
