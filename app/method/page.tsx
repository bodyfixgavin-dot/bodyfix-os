  ...
  return (
    <main className="portal-page portal-detail-page method-page">
      <div className="portal-detail-shell method-shell">
        ...
        <aside className="portal-boundary method-boundary"><p className="portal-kicker">Safety Boundary</p><h2>先知道不做什麼，方法才有成立的邊界。</h2><div className="method-boundary-grid"><div><h3>BodyFix 會教</h3><p>・身體狀態與代償觀察<br/>・低痛感外部整理原則<br/>・筋膜線與動作回測方法<br/>・操作說明、明確同意與停止權<br/>・課後追蹤與服務紀錄框架</p></div><div><h3>BodyFix 不取代</h3><p>・醫療建議與疾病處置<br/>・關節矯正或整骨宣稱<br/>・內部處理或侵入性操作<br/>・泌尿、排便或性功能療效承諾<br/>・任何保證改善或永久改變的宣稱</p></div></div><p className="method-emphasis">我們教判讀，但不把判讀說成醫療判定；我們教整理，但不把整理包裝成醫療處置。</p><p>BodyFix Method 會教身體狀態判讀，但不取代醫療建議；不教醫療處置、不宣稱矯正效果，也不承諾療效。</p></aside>
