    ...
    <ClinicShell title="Clinic Dashboard" subtitle="判讀 → 整理 → 整合 → 接回使用。這裡是客戶紀錄與身體狀態管理中樞。">
      ...
      {data && <>
        <section className="clinic-quick bf-section-gap">
          ...
          <Link className="bf-small-btn" href="/clinic/intake-submissions">問卷回覆</Link>
          <Link className="bf-small-btn" href="/clinic/clients">搜尋客戶入口</Link>
          <Link className="bf-small-btn" href="/clinic/strategy-swot">前往策略分析</Link>
        </section>
        <section className="clinic-grid bf-section-gap">
          ...
          <Link className="bf-card clinic-dashboard-card-link" href="/clinic/strategy-swot"><h2 className="bf-section-title">策略 SWOT</h2><p>檢視 BodyFix OS 的優勢、弱點、機會與風險。</p><span>前往策略分析</span></Link>
        </section>
      </>}
    </ClinicShell>
  );
